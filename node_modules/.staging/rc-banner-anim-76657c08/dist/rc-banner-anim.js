...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_27__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tween__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TweenOneGroup__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__easing__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ticker__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__util__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Tween__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ticker__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__easing__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__util_js__ = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tween_functions__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BannerAnim__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Arrow__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Element__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Thumb__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rc_tween_one__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Arrow__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Thumb__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__utils__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__anim__ = __webpack_require__(29);
...
var BannerAnim = function (_Component) {
  ...
  function BannerAnim(props) {
    ...
    _this.onMouseEnter = function (e) {
      ...
      if (_this.props.autoPlay && _this.props.autoPlayEffect) {
        __WEBPACK_IMPORTED_MODULE_8_rc_tween_one__["c" /* ticker */].clear(_this.autoPlayId);
        _this.autoPlayId = -1;
      }
    };
    ...
    _this.autoPlay = function () {
      _this.autoPlayId = __WEBPACK_IMPORTED_MODULE_8_rc_tween_one__["c" /* ticker */].interval(_this.next, _this.props.autoPlaySpeed);
    };
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(BannerAnim, [{
    ...
    value: function componentWillUnmount() {
      if (this.autoPlayId) {
        __WEBPACK_IMPORTED_MODULE_8_rc_tween_one__["c" /* ticker */].clear(this.autoPlayId);
        this.autoPlayId = 0;
      }
      if (window.addEventListener) {
    ...
    value: function render() {
      ...
      var props = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, this.props);
      ['type', 'prefixCls', 'component', 'initShow', 'duration', 'delay', 'ease', 'arrow', 'thumb', 'autoPlaySpeed', 'autoPlay', 'thumbFloat', 'sync', 'dragPlay', 'autoPlayEffect'].forEach(function (key) {
        return delete props[key];
      });
...
BannerAnim.propTypes = {
  ...
  autoPlayEffect: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.bool,
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_tween_functions__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__BgElement__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__utils__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__anim__ = __webpack_require__(29);
...
var Element = function (_Component) {
  ...
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(Element, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.tickerId !== -1) {
        __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(this.tickerId);
        this.tickerId = -1;
      }
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(this.timeoutID);
      __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(this.delayTimeout);
      this.delayTimeout = -1;
      this.timeoutID = -1;
    }
  }, {
    ...
    value: function render() {
      ...
      if (this.state.show === show && !this.state.mouseMoveType || this.state.mouseMoveType === 'reChild') {
        ...
        if (!show) {
          ...
          return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["b" /* default */], props, bgElem);
        }
        if (this.props.followParallax) {
          props.onMouseMove = this.getFollowMouseMove();
        }
        return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["b" /* default */], props, this.props.mouseMoveType === 'update' ? bgElem : this.getChildren());
      }
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onMouseMove = function (e) {
    ...
    _this2.offsetTop = _this2.domRect.top + Object(__WEBPACK_IMPORTED_MODULE_13__utils__["b" /* currentScrollTop */])();
    _this2.offsetLeft = _this2.domRect.left + Object(__WEBPACK_IMPORTED_MODULE_13__utils__["a" /* currentScrollLeft */])();
    var mouseXY = {
  ...
  this.setTicker = function (followParallax, mouseXY) {
    ...
    __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(_this2.tickerId);
    _this2.tickerId = 'bannerElementTicker' + (Date.now() + Math.random());
    var startFrame = __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].frame;
    ...
    __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].wake(_this2.tickerId, function () {
      var moment = (__WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].frame - startFrame) * __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].perFrame;
  ...
  this.getFollowMouseMove = function () {
    ...
    if (_this2.followParallax) {
      if (_this2.followParallax.delay) {
        ...
        _this2.delayTimeout = _this2.delayTimeout || __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].timeout(function () {
          _this2.setState({
  ...
  this.getChildren = function () {
    return Object(__WEBPACK_IMPORTED_MODULE_13__utils__["f" /* toArrayChildren */])(_this2.props.children).map(function (item, i) {
      ...
      return _this2.useTagComp ? Object(__WEBPACK_IMPORTED_MODULE_13__utils__["d" /* setAnimCompToTagComp */])(item, i) : item;
    });
  };
  ...
  this.animChildren = function (props, style, bgElem) {
    ...
    if (_this2.delayTimeout) {
      __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(_this2.delayTimeout);
    ...
    _this2.useTagComp = (currentAnimType === __WEBPACK_IMPORTED_MODULE_14__anim__["a" /* default */].gridBar || currentAnimType === __WEBPACK_IMPORTED_MODULE_14__anim__["a" /* default */].grid) && (show === _this2.state.show || _this2.state.show && !show);
    // 状态没改，锁定 children 
    props.children = !sync && (show && show !== _this2.state.show || !show && !_this2.state.show) ? bgElem : _this2.getChildren();
    var childrenToRender = __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["b" /* default */], props);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rc_tween_one__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_style_utils__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utils__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__anim__ = __webpack_require__(29);
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(BgElement, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.scrollParallax) {
        this.tween = new __WEBPACK_IMPORTED_MODULE_8_rc_tween_one__["a" /* Tween */](this.dom, [__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
